...
class MoviesCategoryAdapter: RecyclerView.Adapter<MoviesCategoryAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MoviesCategoryAdapter.ViewHolder {
        return ViewHolder(
    ...
    override fun onBindViewHolder(holder: MoviesCategoryAdapter.ViewHolder, position: Int) {
